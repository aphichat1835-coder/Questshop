...
| Checkout | actor/guild/channel-bound session; encrypted token; pagination; quote hash/version; external preflight; account uniqueness; bulk item reserve |
...
| Outbox | transactionally enqueued projection; latest-state rendering; message lease; Discord error contract; durable attempts; replay-linked DLQ |
