...
test('catalog retests are event-driven, contract-pinned, and maintenance does not force a 24-hour retest', async () => {
  ...
  assert.match(catalog, /current_contract_hash !== normalized\.contractHash/);
