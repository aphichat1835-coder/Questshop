...
export const ROUTE_CONTRACTS = Object.freeze({
  ...
  wallet_adjust_confirm: admin('BUTTON'), refund_prepare: admin('BUTTON'),
  refund_item_pick: admin('STRING_SELECT', 'MODAL'), refund_prepare_submit: admin('MODAL_SUBMIT'),
  refund_confirm: admin('BUTTON'), payment_review_pick: admin('STRING_SELECT'),
  ...
  price_category_confirm: admin('BUTTON'), promo_set: admin('BUTTON', 'MODAL'),
  promo_set_submit: admin('MODAL_SUBMIT'), promo_set_confirm: admin('BUTTON'),
  promo_toggle: admin('BUTTON'), promo_toggle_confirm: admin('BUTTON'),
  ...
  receiver_activate_submit: owner('MODAL_SUBMIT'), receiver_activate_confirm: owner('BUTTON'),
