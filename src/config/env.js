...
const schema = z.object({
  ...
  DATABASE_BACKUP_URL: z.string().url(),
  DATABASE_RESTORE_URL: z.string().url(),
  ...
  BACKUP_ENCRYPTION_KEYS_JSON: z.string().transform(jsonKeyring),
  ...
  for (const key of ['DATABASE_POOL_URL', 'DATABASE_DIRECT_URL', 'DATABASE_BACKUP_URL', 'DATABASE_RESTORE_URL']) {
